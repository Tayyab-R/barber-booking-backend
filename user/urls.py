...
urlpatterns = [
    ...
    path('barber/slots/book/<int:pk>/', views.BookBarberSlot),
    path('barber/slots/cancel/<int:pk>/', views.BookBarberSlot),
    path('barber/slots/delete/<int:pk>/', views.BookBarberSlot),
